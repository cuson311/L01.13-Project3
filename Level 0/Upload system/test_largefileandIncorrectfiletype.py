...
class TestLargefileandIncorrectfiletype():
  ...
  def test_largefileandIncorrectfiletype(self):
    ...
    self.driver.find_element(By.NAME, "repo_upload_file").send_keys("C:\\Software-Testing\\vipboard.mp4")
