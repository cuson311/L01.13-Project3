...
class TestToomanyfilesLargefileandIncorrectfiletype():
  ...
  def test_toomanyfilesLargefileandIncorrectfiletype(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.invisibility_of_element_located((By.CSS_SELECTOR, ".fa-file-o")))
